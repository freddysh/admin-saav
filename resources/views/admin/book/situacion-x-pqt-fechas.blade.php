                    ...
                    @foreach($cotizaciones->sortBy('fecha') as $cotizacion)
                        @foreach($cotizacion->paquete_cotizaciones as $paquete_cotizaciones)
                            @foreach($paquete_cotizaciones->itinerario_cotizaciones->sortBy('fecha') as $itinerario_cotizaciones)
                                @foreach($itinerario_cotizaciones->hotel->sortBy('fecha_venc') as $hotel)
            ...
            <div id="tours" class="tab-pane fade show ">
                <table class="table table-striped table-hover table-bordered table-responsive table-condensed mt-2">
                    ...
                    @foreach($cotizaciones->sortBy('fecha') as $cotizacion)
                        @foreach($cotizacion->paquete_cotizaciones as $paquete_cotizaciones)
                            @foreach($paquete_cotizaciones->itinerario_cotizaciones->sortBy('fecha') as $itinerario_cotizaciones)
                                @foreach($itinerario_cotizaciones->itinerario_servicios->sortBy('fecha_venc') as $itinerario_servicios)
