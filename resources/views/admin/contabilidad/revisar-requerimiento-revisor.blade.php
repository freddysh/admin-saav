                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-4 borde-danger">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    @foreach ($requerimientos->where('estado','2') as $key => $requerimiento)
                                        <div class="row mb-2 border border-top-0 border-right-0 border-left-0">
                                            <div class="col-3 px-1 text-left text-11">
                                                @if(isset($requerimiento->estado))
                                                    @if($requerimiento->estado=='2'||$requerimiento->estado=='3'||$requerimiento->estado=='4'||$requerimiento->estado=='5')
                                                        <a href="{{route('contabilidad.operaciones_requerimiento',[$requerimiento->id,'aprobar'])}}" ><b class="text-success">{{$requerimiento->codigo}}</b> <b><i class="fas fa-eye"></i></b></a>
                                            ...
                                            <div class="col-4 px-0 text-center text-11">
                                                <b>{{MisFunciones::fecha_peru_hora_nros($requerimiento->created_at)}}</b>
                                            </div>
                        ...
                        <div class="col-4  borde-info">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    @foreach ($requerimientos->whereIn('estado',['3','4']) as $key => $requerimiento)
                                        <div class="row mb-2 border border-top-0 border-right-0 border-left-0">
                                            <div class="col-3 px-1 text-left text-11">
                                                @if(isset($requerimiento->estado))
                                                    @if($requerimiento->estado=='2'||$requerimiento->estado=='3'||$requerimiento->estado=='4'||$requerimiento->estado=='5')
